...
namespace YovevElectric.Data.Migrations
{
    ...
    [Migration("20200510130152_AddUserIdToBagAndProductQuantity")]
    partial class AddUserIdToBagAndProductQuantity
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YovevElectric.Data.Models.ApplicationRole", b =>
                {
            ...
            modelBuilder.Entity("YovevElectric.Data.Models.OrderData", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("YovevElectric.Data.Models.Setting", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<string>", b =>
                {
                    b.HasOne("YovevElectric.Data.Models.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("YovevElectric.Data.Models.ApplicationUser", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("YovevElectric.Data.Models.Bag", b =>
                {
                    b.HasOne("YovevElectric.Data.Models.OrderData", "OrderData")
                        .WithMany()
